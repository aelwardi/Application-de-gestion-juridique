...
const fetchTickets = async () => {
  ...
  try {
    ...
    if (filters.value.assignedToMe) params.append('assignedToMe', 'true');
...
const closeTicket = async () => {
  ...
  if (!confirm('Êtes-vous sûr de vouloir clôturer ce ticket ? Le client/avocat devra créer un nouveau ticket pour vous contacter à nouveau.')) {
    return;
  }
        ...
        <div class="lg:col-span-2 bg-white rounded-lg shadow-sm border border-gray-200 flex flex-col overflow-hidden">
          <div v-if="selectedTicket" class="flex flex-col h-full">
            ...
            <div v-else class="p-4 border-t border-gray-200 bg-gray-50 text-center flex-shrink-0">
              <p class="text-sm text-gray-600">Ce ticket est clôturé</p>
            </div>
          </div>
          ...
          <div v-else class="flex-1 flex items-center justify-center">
            <div class="text-center">
              ...
              <p class="text-gray-600 font-medium">Sélectionnez un ticket</p>
