              ...
              <div class="flex-grow min-w-0">
                ...
                <div class="flex items-center justify-between">
                  ...
                  <div class="flex items-center gap-2">
                    <!-- Bouton Détails (pour les offres) -->
                    <button
                    ...
                    <!-- Bouton Accepter (pour les offres) -->
                    <button
                      v-if="notification.type === 'offer' && authStore.isLawyer"
                    ...
                    <!-- Bouton Refuser (pour les offres) -->
                    <button
                      v-if="notification.type === 'offer' && authStore.isLawyer"
...
// Utiliser directement les notifications du store
...
const deleteNotif = async (notificationId: string) => {
  ...
  // Pour l'instant, on la marque juste comme lue
